<template>
  <div class="hello">
    ...
    <form action="http://localhost:3001/" method="get">
        <h1>Rota que cria atabela se ela nao existir</h1><br>
        <button type="submit">Criar</button>
    </form><br>

    <form action="http://localhost:3001/select" method="get">
        <h1>Rota select</h1><br>
    ...
    <form action="http://localhost:3001/update" method="post">
        <h1>update</h1>
        <input type="text" name="nome" placeholder="Nome"><br>
    ...
    <form action="http://localhost:3001/delete" method="post">
        <input type="text" name="nome" placeholder="Nome para deletar"><br>
